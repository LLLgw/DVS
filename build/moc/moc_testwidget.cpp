...
QT_MOC_LITERAL(1, 11, 11), // "sendTestCmd"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "cmd"
QT_MOC_LITERAL(4, 28, 16), // "startReceiveData"
QT_MOC_LITERAL(5, 45, 15), // "stopReceiveData"
QT_MOC_LITERAL(6, 61, 9), // "startTest"
QT_MOC_LITERAL(7, 71, 8), // "stopTest"
QT_MOC_LITERAL(8, 80, 14) // "displayRawData"

    },
    "TestWidget\0sendTestCmd\0\0cmd\0"
    "startReceiveData\0stopReceiveData\0"
    "startTest\0stopTest\0displayRawData"
};
...
void TestWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendTestCmd((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->startReceiveData(); break;
        case 2: _t->stopReceiveData(); break;
        case 3: _t->startTest(); break;
        case 4: _t->stopTest(); break;
        case 5: _t->displayRawData(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TestWidget::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestWidget::sendTestCmd)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestWidget::startReceiveData)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TestWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestWidget::stopReceiveData)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void TestWidget::sendTestCmd(QByteArray _t1)
{
...
// SIGNAL 1
void TestWidget::startReceiveData()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TestWidget::stopReceiveData()
{
